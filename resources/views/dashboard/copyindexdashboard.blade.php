...
/* SIDEBAR */
.sidebar{width:250px;flex-shrink:0;background:linear-gradient(180deg,#0a1628 0%,#0d2137 60%,#0a3d2e 100%);position:fixed;top:0;left:0;height:100vh;display:flex;flex-direction:column;z-index:100}
.sb-logo{padding:22px 20px 18px;border-bottom:1px solid rgba(255,255,255,.08)}
.sb-logo-row{display:flex;align-items:center;gap:10px}
.sb-icon{width:38px;height:38px;border-radius:10px;background:linear-gradient(150deg,var(white),var(white));display:flex;align-items:center;justify-content:center;color:var(--yellow);font-size:16px}
.sb-logo h1{font-size:.99rem;font-weight:700;color:#fff}
...
@section('content')
    <div class="header-page">
        <h2>Dashboard Cakupan PHBS</h2>
        <p>Selamat datang kembali, Admin Dinas Kesehatan Sleman.</p>
    </div>

    <div class="card-container" style="margin-top: 20px; background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
        <h3>Grafik PHBS Sleman</h3>
        <p>Isi data visualisasi PHBS ditaruh di area ini...</p>
    </div>
@endsection --}}
...
<aside class="sidebar">
  <div class="sb-logo">
    <div class="sb-logo-row">
      {{-- <div class="sb-icon"><img src="{{ asset('image/logo-phbs.jpg') }}" alt="Logo PHBS" style="max-width: 120%; height: auto;"></div> --}}
...
<div class="main">
  <div class="topbar">
    <div class="topbar-left">
      ...
      <p>Selamat datang, {{ auth()->user()->name ?? 'Admin' }}
    </div>
