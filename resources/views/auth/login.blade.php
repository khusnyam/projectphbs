...
<style>
/* Salin semua CSS dari § 1 s/d § 2 dari file style_css_gabungan */
*{box-sizing:border-box;margin:0;padding:0}
body{font-family:'Inter',sans-serif;min-height:100vh;display:flex;background:#0a1628}
.wrap{width:100%;min-height:100vh;background:linear-gradient(160deg,#0a1628 0%,#0d2137 40%,#0a3d2e 100%);display:flex;align-items:stretch;position:relative;overflow:hidden}
...
.right-header{display:flex;align-items:center;gap:12px;margin-bottom:28px}
.logo-box{width:44px;height:44px;border-radius:12px;background:linear-gradient(135deg,#0f1629,#2563eb);display:flex;align-items:center;justify-content:center}
.logo-box i{color:#FFCC00;font-size:18px}
.logo-text h2{font-size:15px;font-weight:800;color:#0f1629;line-height:1.2}
.logo-text p{font-size:11px;color:#888}
.right-card h3{font-size:22px;font-weight:800;color:#0f1629;margin-bottom:4px}
.right-card .sub2{font-size:12px;color:#888;margin-bottom:20px}
.form-group{margin-bottom:14px}
.form-group label{display:block;font-size:11px;font-weight:700;color:#64748b;margin-bottom:5px;letter-spacing:.05em;text-transform:uppercase}
.input-wrap{position:relative}
.input-wrap i.icon-left{position:absolute;left:13px;top:50%;transform:translateY(-50%);color:#9ca3af;font-size:13px}
.input-wrap input{width:100%;padding:11px 14px 11px 38px;background:#fff;border:1.5px solid #e2e8f0;border-radius:10px;font-size:13px;color:#0f172a;font-family:'Inter',sans-serif;outline:none;transition:border .2s,box-shadow .2s}
...
.input-wrap input.is-invalid{border-color:#ef4444;background:#fff8f8}
...
.invalid-msg{font-size:11px;color:#ef4444;margin-top:4px;display:flex;align-items:center;gap:4px}
...
.check-label input{accent-color:#2563eb}
.lupa{font-size:12px;color:#2563eb;font-weight:600;text-decoration:none}
.btn-login{width:100%;padding:13px;background:linear-gradient(135deg,#0f1629,#2563eb);color:#FFCC00;border:none;border-radius:10px;font-size:14px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:opacity .2s;font-family:'Inter',sans-serif;margin-bottom:20px}
...
.role-badge{flex:1;display:flex;flex-direction:column;align-items:center;gap:5px;padding:9px 6px;border:1.5px solid #e2e8f0;border-radius:10px;font-size:10px;color:#555;font-weight:600;cursor:default;background:#fff}
.role-badge i{font-size:16px;color:#2563eb}
.foot{text-align:center;font-size:10px;color:#bbb;margin-top:16px}
@media(max-width:768px){.wrap{flex-direction:column}.left{width:100%;padding:40px 28px}.right{width:100%;padding:24px 20px}.left h1{font-size:28px}.float-btns{display:none}}
</style>
</head>
<body>
<div class="wrap">
  ...
  <div class="left">
    ...
    <div class="info-badge">
      <i class="fa-solid fa-hospital"></i> Puskesmas Kabupaten Sleman
    </div>
    <div class="stats">
