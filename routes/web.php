...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard', [DashboardController::class, 'dinkes'])
        ->name('dashboard.dinkes');

    Route::get('/dashboard/puskesmas', [DashboardController::class, 'puskesmas'])
        ->name('dashboard.puskesmas');

    // Alias /dashboard → auto redirect sesuai role
    Route::get('/dashboard/redirect', [DashboardController::class, 'redirect'])
        ->name('dashboard');

    // PHBS
    Route::get('/phbs', [PhbsController::class, 'index'])
        ->name('phbs.index');

    Route::get('/phbs/form', [PhbsController::class, 'form'])
        ->name('phbs.form');

    Route::get('/phbs/export', [PhbsController::class, 'exportExcel'])
        ->name('phbs.export');
});
